...
function RecolectDataContraparte(props) {
      ...
      <div className="row">
        ...
        <div className="col-6" style={{ padding: "10%", textAlign: "left", paddingTop: "10%" }}>
          ...
          <div style={{ padding: "10%", paddingTop: "20%" }}>
            ...
            <h2 style={{ color: "grey", backgroundColor: "white", borderRadius: "10px", padding: "2%" }}>{props.formulario.nombresContraparte} {props.formulario.apellidosContraparte}</h2>
...
export default RecolectDataContraparte;
